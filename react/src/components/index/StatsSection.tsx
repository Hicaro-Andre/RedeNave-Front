        ...
        <div className="row text-center">
          <div className="col-md-3 col-6 mb-3 mb-md-0">
            <div className="stat-card">
              ...
              <p className="text-muted mb-0">Mulheres Capacitadas</p>
            </div>
          </div>
          ...
          <div className="col-md-3 col-6 mb-3 mb-md-0">
            <div className="stat-card">
              ...
              <p className="text-muted mb-0">Cursos Disponíveis</p>
            </div>
          </div>
          ...
          <div className="col-md-3 col-6">
            <div className="stat-card">
              ...
              <p className="text-muted mb-0">Taxa de Satisfação</p>
            </div>
          </div>
          ...
          <div className="col-md-3 col-6">
            <div className="stat-card">
              ...
              <p className="text-muted mb-0">Online e Gratuito</p>
            </div>
          </div>
        </div>
      </div>
