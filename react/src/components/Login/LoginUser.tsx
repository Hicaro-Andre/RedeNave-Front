              ...
              <div className="row g-0">
                ...
                <div className="col-md-5 login-image text-white d-none d-md-flex flex-column">
                  <div className="text-center">
                    ...
                    <p className="mt-3 px-4 text-white">Continue sua jornada empreendedora e alcance seus objetivos.</p>

                    <div className="mt-5">
                      <div className="d-flex align-items-center justify-content-center mb-3">
                        <i className="bi bi-check-circle-fill me-2" style={{ color: "#09CDD7" }}></i>
